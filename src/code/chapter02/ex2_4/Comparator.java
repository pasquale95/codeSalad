...
import chapter02.ex2_4.pre.Solution;
...
public class Comparator extends ComparatorTemplate {
    ...
    protected ExerciseSolutions getExerciseSolutions(JSONObject params) {
        ...
        return new ExerciseSolutions(new Solution(head.clone(), threshold), new chapter02.ex2_4.post.Solution(head.clone(), threshold));
    }
