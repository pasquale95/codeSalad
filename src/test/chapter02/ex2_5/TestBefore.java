 ...
 */
@Tag("Before")
@DisplayName("Ex2.5: Sum Lists (Before)")
public class TestBefore {
    ...
    void check(
        ...
        if (order.equals("reverse")) {
            assertEquals(expected, Before.reverseOrderSum(addend1, addend2));
        } else {
            assertEquals(expected, Before.forwardOrderSum(addend1, addend2));
        }
    }
}
